    ...
    overview: {
      de: {
        ...
        blocks: [
          ...
          {
            type: 'paragraph',
            content: 'Das Modul **erzeugt keine Lösungen** — es zwingt zur scharfen Formulierung des Ziels und zur Gap-Analyse: Was hindert das System heute am IFR? Diese Lücke ist die eigentliche {{term:problembeschreibung|Problemstellung}}.',
          },
        ],
      },
      en: {
        ...
        blocks: [
          {
            ...
            items: [
              ...
              'IFR-3 formulieren: Welche Ressource im Supersystem könnte die Funktion übernehmen? Hier hilft die {{term:ressourcen-analyse|Ressourcen-Checkliste}} als nächster Schritt.',
          ...
          {
            type: 'paragraph',
            content: 'Bei mehreren konkurrierenden nützlichen Funktionen empfiehlt sich ein eigener IFR pro Funktion. Häufig zeigt sich dabei, dass die Funktionen miteinander im Konflikt stehen — das ist dann ein Fall für die {{term:widerspruchsmatrix|Widerspruchsmatrix}} oder den physikalischen Widerspruch.',
          },
        ],
      },
      en: {
