/**
 * D.Mike — MSA Typ 2 Engine (msa-typ2-engine.js)
 * Pure computation functions for Measurement System Analysis Type 2 (Gage R&R).
 * ANOVA-based crossed study: multiple operators × multiple parts × replicates.
...
/**
 * Validate input data for Gage R&R analysis.
 * @param {{ parts: string[], operators: string[], measurements: number[] }} data
 * @param {{ lsl?: number, usl?: number }} options
 * @returns {{ valid: boolean, errorKey: string|null, errorVars: object|null, p?: number, o?: number, r?: number }}
 */
export function validate(data, options = {}) {
  ...
  return { valid: true, errorKey: null, errorVars: null, p, o, r };
}
...
/**
 * Run the full ANOVA-based Gage R&R analysis.
 * @param {{ parts: string[], operators: string[], measurements: number[] }} data
