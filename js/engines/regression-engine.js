...
// The generic matrix helpers now live in their own module so other engines can
// use them without pulling in the regression machinery. Re-exported here so
// every existing import of `regression-engine.js` keeps working unchanged.
export {
