/**
 * D.Mike — Box-Cox Transformed I-MR Engine Fixture Validation
 */

import { suite, test, assertAlmostEqual, assertEqual } from '../test-utils.js';
import { analyze } from '../../js/engines/transformed-chart-engine.js';
...
const data = await loadFixture('../fixtures/control-charts/transformed-imr-chart.fixtures.json');

suite('Transformed I-MR (fixture validation)', () => {
