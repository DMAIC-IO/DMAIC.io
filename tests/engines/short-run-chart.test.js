/**
 * D.Mike — Short-Run (Z-MR) Engine Fixture Validation
 */

import { suite, test, assertAlmostEqual, assertEqual } from '../test-utils.js';
import { analyze } from '../../js/engines/short-run-chart-engine.js';
...
const data = await loadFixture('../fixtures/control-charts/short-run-chart.fixtures.json');

suite('Short-Run Z-MR (fixture validation)', () => {
