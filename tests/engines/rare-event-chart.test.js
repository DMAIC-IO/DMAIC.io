/**
 * D.Mike — Rare-Event Chart Engine Fixture Validation
 * Validates g and t chart limits.
 */

import { suite, test, assertAlmostEqual, assertEqual } from '../test-utils.js';
import { analyze } from '../../js/engines/rare-event-chart-engine.js';
...
const data = await loadFixture('../fixtures/control-charts/rare-event-chart.fixtures.json');

suite('Rare-Event Charts — g / t (fixture validation)', () => {
