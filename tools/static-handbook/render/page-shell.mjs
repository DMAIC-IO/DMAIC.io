...
const UI_STRINGS = {
  de: {
    ...
    training: {
      ...
      eightdTitle: '8D verstehen',
      eightdShort: 'Die acht Disziplinen (D0–D8) zur reaktiven Fehlerbehebung — von der Sofortmaßnahme über die Ursachenanalyse bis zur dauerhaften Vorbeugung und Würdigung des Teams.',
    ...
    phase: {
      ...
      design: 'Design',
      verify: 'Verify',
      prepare: 'D0 — Vorbereitung',
      team: 'D1 — Team aufstellen',
      problem: 'D2 — Problem beschreiben',
      containment: 'D3 — Sofortmaßnahmen',
      rootcause: 'D4 — Ursachenanalyse',
      corrective: 'D5 — Abstellmaßnahmen',
      implementation: 'D6 — Umsetzung',
      prevent: 'D7 — Wiederholung verhindern',
      recognize: 'D8 — Team würdigen',
    ...
    phaseIntro: {
      ...
      prepare: 'D0 des 8D-Zyklus — Eintrittskriterien klären, Notfallmaßnahmen einleiten, entscheiden ob 8D der richtige Prozess ist.',
      team: 'D1 des 8D-Zyklus — Champion, Teamleiter, Kernteam und erweitertes Team formieren; Rollen und Befugnisse klären.',
      problem: 'D2 des 8D-Zyklus — Problem präzise beschreiben (Is/Is-Not, 5W2H), Prozess- und Messsystem-Kontext sichern.',
      containment: 'D3 des 8D-Zyklus — Sofortmaßnahmen zum Schutz des Kunden, bevor die Ursache bekannt ist (temporär, wirksamkeits­überwacht).',
      rootcause: 'D4 des 8D-Zyklus — Auftretens-, Nicht-Entdeckungs- und Systemursachen statistisch oder physikalisch belegen.',
      corrective: 'D5 des 8D-Zyklus — Permanente Abstellmaßnahmen planen, Alternativen bewerten, Wirksamkeit verifizieren.',
      implementation: 'D6 des 8D-Zyklus — Abstellmaßnahmen flächendeckend umsetzen, Wirkung im Echtbetrieb validieren, Sofortmaßnahmen zurückfahren.',
      prevent: 'D7 des 8D-Zyklus — Standards, Spezifikationen, FMEAs und Schulungspläne anpassen, damit das Problem nirgendwo wiederkehrt.',
      recognize: 'D8 des 8D-Zyklus — Erfolg sichtbar machen, Team entlasten, Lessons Learned dokumentieren und kommunizieren.',
  ...
  en: {
    ...
    training: {
      ...
      eightdTitle: 'Understanding 8D',
      eightdShort: 'The Eight Disciplines (D0–D8) for reactive defect resolution — from immediate containment through root-cause analysis to durable prevention and team recognition.',
    ...
    phase: {
      ...
      verify: 'Verify',
      prepare: 'D0 — Prepare',
      team: 'D1 — Build the Team',
      problem: 'D2 — Describe the Problem',
      containment: 'D3 — Containment',
      rootcause: 'D4 — Root Cause Analysis',
      corrective: 'D5 — Corrective Actions',
      implementation: 'D6 — Implementation',
      prevent: 'D7 — Prevent Recurrence',
      recognize: 'D8 — Recognize the Team',
      data: 'Data & Tools',
      extras: 'More',
    },
    phaseIntro: {
      ...
      prepare: 'D0 of the 8D cycle — settle entry criteria, launch emergency response actions, decide whether 8D is the right process.',
      team: 'D1 of the 8D cycle — assemble champion, team lead, core team and extended team; clarify roles and authority.',
      problem: 'D2 of the 8D cycle — describe the problem precisely (Is/Is-Not, 5W2H) and capture process and measurement context.',
      containment: 'D3 of the 8D cycle — containment actions that protect the customer before the root cause is known (temporary, effectiveness-monitored).',
      rootcause: 'D4 of the 8D cycle — prove occurrence, escape and systemic causes statistically or physically.',
      corrective: 'D5 of the 8D cycle — plan permanent corrective actions, evaluate alternatives, verify effectiveness.',
      implementation: 'D6 of the 8D cycle — roll out corrective actions across the full scope, validate effect in live operation, retire containment.',
      prevent: 'D7 of the 8D cycle — update standards, specifications, FMEAs and training plans so the problem cannot recur anywhere.',
      recognize: 'D8 of the 8D cycle — make the success visible, discharge the team, document and communicate the lessons learned.',
